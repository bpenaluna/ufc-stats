...
if __name__ == '__main__':
    ...
    fight_details = scraper.scrape_fight_details(lim=1)
    fighter_details = scraper.scrape_fighter_details(lim=1)
    scraper.close()

    print(fight_details.head())
    print(fight_details.columns)
    print(fighter_details.head())
